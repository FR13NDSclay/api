...
const access_token = process.env.ACCESS_TOKEN; // Only one access token
...
app.get('/', async (req, res) => {
    ...
    let token = req.query.token || access_token; // Use query token if provided, otherwise use the access token
